...
const Editcountry = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios({
            method: 'POST',
            url: `${process.env.REACT_APP_URL}/country/updatecountry/${id}`,
            data: passData,
            headers: {
                "Content-Type": "application/json",
                Authorization: token,
                            ...
                            <CCard className="mx-4">
                                <CCardBody className="p-4">
                                    ...
                                    <CForm onSubmit={handleSubmit} >
                                        <h3 className='text-center'>Edit Country</h3><br />
                                        ...
                                        <div className="d-grid">
                                            <CButton color="success" type='submit'>Edit Country</CButton>
                                        </div>
