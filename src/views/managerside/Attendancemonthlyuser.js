...
const Attendancemonthlyuser = (props) => {

    const id = props?.match?.params?.assign_id;
    console.log(id);
    ...
    const handleSearch = () => {
        ...
        // axios({
        //     method: 'GET',
        //     url: `${process.env.REACT_APP_URL}/reporting/usermonthlyreport/${assign_id}?year=${year}&month=${month}`,
        //     headers: {
...
export default Attendancemonthlyuser